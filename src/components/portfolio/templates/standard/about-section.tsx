        ...
        <div className="flex flex-col w-full items-center justify-center border-t border-b border-gray-200 dark:border-[#27282D]">
            <div className="flex gap-4 w-full p-4 items-center border-b border-gray-200 dark:border-[#27282D]">
                ...
                <div className="h-full flex flex-col gap-4 px-4">
                    ...
                    <div className="flex w-fit items-center border border-gray-200 dark:border-[#27282D] rounded-md overflow-hidden bg-white dark:bg-transparent">

                        <a
                            href={`https://github.com/${username}`}
                            target="_blank"
                            rel="noreferrer"
                            className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 border-r border-gray-200 dark:border-[#27282D] transition-colors duration-200"
                        >
...

            {
                company && (
                    <div className="w-full flex items-center gap-4 p-4">
                        <div className="w-12 h-12 rounded-full border-2 border-gray-300 dark:border-[#27282D] flex items-center justify-center">
