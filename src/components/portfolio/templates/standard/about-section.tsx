        ...
        <div className="flex flex-col w-full items-center justify-center border-t border-b border-gray-200 dark:border-[#27282D]">
            <div className="flex gap-4 w-full p-4 items-center border-b border-gray-200 dark:border-[#27282D]">
                ...
                <div className="h-full flex flex-col gap-4 px-4">
                    ...
                    <div className="flex gap-6 items-center border border-gray-200 dark:border-[#27282D] p-2 rounded-md w-fit">
                        <a href={`https://github.com/${username}`} rel="noreferrer nopener" target="_blank">
                        ...
                        <a href={`https://twitter.com/${links.twitterUsername}`} rel="noreferrer nopener" target="_blank">
                        ...
                        <a href={`https://${links.blog}`} rel="noreferrer nopener" target="_blank">
