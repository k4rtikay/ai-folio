    ...
    return (
        <form action="" className="flex flex-row gap-2 p-1" onSubmit={handleSubmit}>
            ...
            <input
                ...
                className="rounded-md border-2 border-neutral-600/50 bg-neutral-800/50 px-2 py-1.5 md:py-2 w-32 md:w-40 lg:w-60 h-fit text-sm md:text-base text-neutral-50 placeholder:text-neutral-500 transition-all duration-125 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500/50 focus:border-neutral-500"
            />
